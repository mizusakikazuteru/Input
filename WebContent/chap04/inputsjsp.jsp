...
<br />
画像(image) : <input type="image" name src="../images/shoppingcart_off.png"/><br />
...
サブミット2 : ${inputsResult.submit2 }
画像.x : ${inputResult.image_x }<br />
画像.y : ${inputResult.image_y }<br />
</c:if>
