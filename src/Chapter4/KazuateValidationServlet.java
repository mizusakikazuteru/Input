...
public class KazuateValidationServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		RequestDispatcher dispatcher = request
				.getRequestDispatcher("kazuateValidation.jsp");
	...
	private void processGuess(HttpServletRequest request) {
		...
		if(isValidParam(request) == false){
			request.setAttribute("message","0～99の数値を入力して下さい。");
			return;
		}
	...
	private v isNewGame(Map<String, String[]> parameterMap){
		return parameterMap.containsKey("newGame");
	}
}
